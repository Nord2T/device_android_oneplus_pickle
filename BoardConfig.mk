...
# Assertation
TARGET_OTA_ASSERT_DEVICE := pickle,OP5567AL1
...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):init_oneplus_pickle
TARGET_RECOVERY_DEVICE_MODULES := init_oneplus_pickle
...
TARGET_KERNEL_ADDITIONAL_FLAGS := KBUILD_BUILD_USER="ShikiSenpai" KBUILD_BUILD_HOST=Compiler
...
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/vendor_overlay/etc/fstab.mt6895

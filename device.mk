...
$(call inherit-product-if-exists, vendor/oneplus/pickle/pickle-vendor.mk)
...
# Bluetooth
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/oneplus/pickle/bluetooth/include
...
PRODUCT_COPY_FILES += \
    device/oneplus/pickle/bluetooth/audio/config/sysbta_audio_policy_configuration.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysbta_audio_policy_configuration.xml \
    device/oneplus/pickle/bluetooth/audio/config/sysbta_audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUTY_SYSTEM)/etc/sysbta_audio_policy_configuration_7_0.xml
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/vendor_overlay/etc/fstab.mt6895:$(TARGET_COPY_OUT_RAMDISK)/fstab.mt6895
...
# Lights
PRODUCT_PACKAGES += \
    android.hardware.light@2.0-service.pickle \
...
# Touch
PRODUCT_PACKAGES += \
    vendor.lineage.touch@1.0-service.pickle
